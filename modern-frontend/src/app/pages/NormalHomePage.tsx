  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B1220]">
      ...
      <section className="relative bg-[#0F172A] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#2563EB]/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/3" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-28">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#F59E0B]/10 border border-[#F59E0B]/20 text-[#F59E0B] text-xs font-bold px-4 py-2 rounded-full mb-6">
              ...
              FixKart — Fixed Fast, Every Time
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
              Tell Us What's{" "}
              <span className="text-[#F59E0B]">Broken</span>
              <br />
              We'll Send the <span className="text-[#2563EB]">Nearest Pro</span>
            </h1>

            <p className="text-lg text-white/50 mb-10 max-w-xl mx-auto leading-relaxed">
              No need to search through lists of professionals. Just pick a service, enter your location, and we'll assign the best verified professional near you.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/booking"
                className="inline-flex items-center justify-center gap-2 bg-[#F59E0B] text-[#0F172A] font-extrabold text-base px-8 py-4 rounded-2xl hover:bg-amber-400 active:scale-95 transition-all shadow-lg shadow-amber-500/25"
              >
                Book a Professional
              ...
              <Link
                to="/products"
                className="inline-flex items-center justify-center gap-2 border-2 border-white/20 text-white font-bold text-base px-8 py-4 rounded-2xl hover:border-white/40 hover:bg-white/5 transition-all"
              >
                Shop Hardware
              </Link>
            </div>
