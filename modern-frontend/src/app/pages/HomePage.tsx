...
function HeroSection() {
  ...
  return (
    <section
      ref={heroRef}
      className="relative h-[650vh] bg-[#0F172A]"
    >
...
const categories = [
  ...
  { Icon: Wrench, name: "Hand Tools", slug: "Hand Tools", count: "520+ Products", color: "#0F172A", bg: "#F1F5F9" },
  { Icon: Paintbrush, name: "Paint & Decor", slug: "Paint & Decor", count: "180+ Products", color: "#EC4899", bg: "#FDF4FF" },
  { Icon: Shield, name: "Safety & Protection", slug: "Safety & Protection", count: "150+ Products", color: "#16A34A", bg: "#F0FDF4" },
  { Icon: Car, name: "Automotive", slug: "Automotive", count: "310+ Products", color: "#7C3AED", bg: "#F5F3FF" },
  { Icon: Hammer, name: "Tools & Equipment", slug: "Tools & Equipment", count: "440+ Products", color: "#D97706", bg: "#FFFBEB" },
  { Icon: Settings, name: "Hardware & Fasteners", slug: "Hardware & Fasteners", count: "200+ Products", color: "#0F172A", bg: "#F8FAFC" },
];
